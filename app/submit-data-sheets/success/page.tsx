      ...
      <Card className="mx-auto w-full max-w-md shadow-md">
        <CardHeader className="flex flex-col items-center space-y-2 pt-6">
          ...
          <CardDescription className="text-center">
            Thank you for contributing your knowledge. Your data has been added to our Google Sheets database.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center space-y-4">
          ...
          <a href={`/submit-data-sheets?t=${timestamp}`} className="w-full">
            <Button className="w-full bg-blue-600 hover:bg-blue-700">Submit More Data</Button>
          </a>
        </CardContent>
